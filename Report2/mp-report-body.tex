...
For the prediction, 50 source frames are feed into the model. The model predicts the first next step using the last feed frame and continues afterwards using the predicted frame as the input for the next prediction until frame 25. The model as well as the training and the prediction process is shown in Figure \ref{fig:prediction}.
