...
train_config['n_epochs'] = 21 # TODO for how many epochs to train (this is currently just a dummy value)
...
train_config['hidden_states'] = 256
...
test_config['model_dir'] = '/home/mrozou/projectMP/MachinePerception/trained_models/a_name_1525942920'  # TODO path to the model that you want to evaluate
