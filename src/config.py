...
train_config['name'] = 'repeat'  # TODO give your model a name if you want
train_config['batch_size'] = 10  # TODO specify a batch size (this is currently just a dummy value)
train_config['max_seq_length'] = 3172  # TODO specify for how many time steps you want to unroll the RNN (this is currently just a dummy value)
train_config['time_stamp']=train_config['max_seq_length'] 
train_config['learning_rate'] = 0.00015# TODO specify a learning rate (this is currently just a dummy value)
train_config['n_epochs'] = 1 # TODO for how many epochs to train (this is currently just a dummy value)
train_config['save_checkpoints_every_epoch'] = 3  # after how many epochs the trained model should be saved
...
test_config['model_dir'] = '/home/catlay/Documents/ETH/2018-MachinePerception/trained_models/repeat_1527700817'  # TODO path to the model that you want to evaluate
