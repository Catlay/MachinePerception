...
train_config['learning_rate_decay_rate'] = 0.5
train_config['gradient_clipping'] = 15 
...
train_config['hidden_states'] = 512 # size of cell
...
train_config['num_layers'] =  4 # number of layers
...
test_config['model_dir'] = '/home/catlay/Documents/ETH/2018-MachinePerception/trained_models/BasicFast_1528818108'  # TODO path to the model that you want to evaluate
