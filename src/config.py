...
train_config['res_vel'] = False # whether to use a residual connection that models velocities.
...
test_config['model_dir'] = '/home/catlay/Documents/ETH/2018-MachinePerception/trained_models/repeat_1527715626 _e18'  # TODO path to the model that you want to evaluate
