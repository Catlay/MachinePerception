...
train_config['learning_rate'] = 0.0015# TODO specify a learning rate (this is currently just a dummy value)
...
train_config['hidden_states'] = 10 # size of cell
...
test_config['model_dir'] = '/home/catlay/Documents/ETH/2018-MachinePerception/trained_models/ML_1529015770'  # TODO path to the model that you want to evaluate
