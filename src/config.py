...
train_config['name'] = 'ML'  # TODO give your model a name if you want
train_config['batch_size'] = 8  # TODO specify a batch size (this is currently just a dummy value)
...
train_config['learning_rate'] = 0.001# TODO specify a learning rate (this is currently just a dummy value)
train_config['n_epochs'] = 12 # TODO for how many epochs to train (this is currently just a dummy value)
...
train_config['which_model'] = 'MultiLSTM' # BasicLSTM, MultiLSTM or Seq2Seq
train_config['hidden_states'] = 1024 # size of cell
...
train_config['keep_prob'] = 0.5 # probability for drop out
train_config['num_layers'] =  2 # number of layers
...
test_config['model_dir'] = '/home/catlay/Documents/ETH/2018-MachinePerception/trained_models/ML_1528990862'  # TODO path to the model that you want to evaluate
