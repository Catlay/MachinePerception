...
train_config['n_epochs'] = 50 # TODO for how many epochs to train (this is currently just a dummy value)
train_config['save_checkpoints_every_epoch'] = 1  # after how many epochs the trained model should be saved
train_config['n_keep_checkpoints'] = 50  # how many saved checkpoints to keep
...
train_config['hidden_states'] = 2048
...
test_config['model_dir'] = '/home/catlay/Documents/ETH/2018-MachinePerception/trained_models/repeat_1527712639'  # TODO path to the model that you want to evaluate
